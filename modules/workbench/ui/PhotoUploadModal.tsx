...
export default function PhotoUploadModal() {
  ...
  const previewAreaState = activePhoto
    ? "bg-[#111] text-white"
    : isDragging
      ? "bg-[var(--periplus-cream)] text-[var(--periplus-ink)]"
      : "bg-[var(--periplus-soft-white)] text-[var(--periplus-ink)]"
  ...
  return (
    <div className="pointer-events-auto fixed inset-0 z-50 flex items-center justify-center bg-black/70 px-4 py-5">
      <div
        ...
        className="flex max-h-[calc(100vh-40px)] w-[min(980px,calc(100vw-32px))] flex-col overflow-hidden rounded-[18px] bg-[var(--periplus-white)] text-[var(--periplus-ink)] shadow-[0_24px_70px_rgb(0_0_0_/_34%)]"
      >
        <header className="grid h-12 shrink-0 grid-cols-[48px_1fr_120px] items-center border-b border-[rgb(44_36_22_/_12%)] px-1">
          <button
            ...
            aria-label="关闭上传弹窗"
            title="关闭"
            className="flex h-10 w-10 items-center justify-center rounded-full text-[var(--periplus-walnut)] transition hover:bg-[rgb(44_36_22_/_7%)] hover:text-[var(--periplus-ink)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--periplus-russet)] disabled:opacity-50"
          >
            <X aria-hidden="true" className="h-5 w-5" />
          </button>
          <h2
            id="photo-upload-title"
            className="text-center text-sm font-black text-[var(--periplus-ink)]"
          >
            创建照片素材
          </h2>
          <button
            ...
            disabled={!canSubmit}
            className="justify-self-end rounded-full px-4 py-2 text-sm font-black text-[var(--periplus-russet)] transition hover:bg-[rgb(217_118_66_/_10%)] hover:text-[var(--periplus-ink)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--periplus-russet)] disabled:cursor-not-allowed disabled:text-[var(--periplus-teak)] disabled:opacity-50"
          >
            {isUploading ? "上传中" : "上传"}
          </button>
        </header>
        ...
        <div className="grid min-h-0 flex-1 lg:grid-cols-[minmax(0,1fr)_360px]">
                    ...
                    return (
                      ...
                      >
                        ...
                        {hasCoordinates(photo) && (
                          <span className="absolute right-1 bottom-1 flex h-4 w-4 items-center justify-center rounded-full bg-[var(--periplus-olive)] text-white">
              ...
              <div className="flex flex-1 flex-col items-center justify-center px-6 text-center">
                <div
                  className={`flex h-24 w-24 items-center justify-center rounded-full border border-dashed ${
                    isDragging
                      ? "border-[var(--periplus-russet)] bg-[rgb(217_118_66_/_10%)] text-[var(--periplus-russet)]"
                      : "border-[rgb(44_36_22_/_18%)] bg-[var(--periplus-white)] text-[var(--periplus-teak)]"
                  }`}
                >
                ...
                <button
                  type="button"
                  onClick={() => inputRef.current?.click()}
                  className="mt-6 rounded-full bg-[var(--periplus-russet)] px-5 py-2.5 text-sm font-black text-[var(--periplus-soft-white)] transition hover:bg-[var(--periplus-ink)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--periplus-russet)]"
                >
                  选择照片
                </button>
                <p className="mt-3 text-xs font-bold text-[var(--periplus-teak)]">
                  或拖拽图片到这里
                </p>
              </div>
            )}
          ...
          <aside className="flex min-h-0 flex-col border-t border-[rgb(44_36_22_/_12%)] bg-[var(--periplus-white)] lg:border-t-0 lg:border-l">
            <div className="flex items-center gap-3 border-b border-[rgb(44_36_22_/_10%)] p-4">
              <span className="flex h-9 w-9 items-center justify-center rounded-full bg-[var(--periplus-cream)] text-[var(--periplus-russet)]">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs font-bold text-[var(--periplus-teak)]">
                  {uploadPhotos.length > 0
              ...
              {activePhoto ? (
                <div className="space-y-5">
                  <textarea
                    ...
                    placeholder="添加描述..."
                    className="h-28 w-full resize-none rounded-[10px] border border-[rgb(44_36_22_/_14%)] bg-[var(--periplus-soft-white)] px-3 py-3 text-sm leading-5 text-[var(--periplus-ink)] transition outline-none placeholder:text-[var(--periplus-teak)]/70 focus:border-[var(--periplus-russet)]"
                  />

                  <div className="rounded-[12px] border border-[rgb(44_36_22_/_12%)] bg-[var(--periplus-soft-white)] p-3">
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0">
                        <p className="flex items-center gap-1.5 text-xs font-black text-[var(--periplus-ink)]">
                          <MapPin
                            aria-hidden="true"
                            className="h-3.5 w-3.5 text-[var(--periplus-russet)]"
                          />
                          坐标
                        </p>
                        <p className="mt-1 text-xs leading-5 font-bold text-[var(--periplus-teak)]">
                      ...
                      <button
                        ...
                        className="shrink-0 rounded-full border border-[rgb(44_36_22_/_12%)] bg-[var(--periplus-white)] px-3 py-1.5 text-xs font-black text-[var(--periplus-russet)] transition hover:border-[var(--periplus-russet)] hover:bg-[rgb(217_118_66_/_8%)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--periplus-russet)]"
                      >
                        {hasCoordinates(activePhoto) ? "重新选择" : "选择坐标"}
                      </button>
                    </div>
                    {activePhoto.hasGPS && hasCoordinates(activePhoto) && (
                      <p className="mt-3 border-t border-[rgb(44_36_22_/_10%)] pt-2 text-[11px] font-bold text-[var(--periplus-olive)]">
                        已读取照片 GPS
                      </p>
                    )}
                  </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between gap-3">
                      ...
                      {missingLocationPhotos.length > 0 && (
                        <p className="text-xs font-black text-[var(--periplus-coral)]">
                        ...
                        return (
                          <div
                            ...
                            className={`flex items-center gap-2 rounded-[10px] border p-2 transition ${
                              isActive
                                ? "border-[var(--periplus-russet)] bg-[rgb(217_118_66_/_7%)]"
                                : "border-[rgb(44_36_22_/_10%)] bg-[var(--periplus-white)]"
                            }`}
                          >
                            <button
                              type="button"
                            ...
                            >
                              ...
                              <span className="min-w-0 flex-1">
                                <span className="block truncate text-xs font-black text-[var(--periplus-ink)]">
                                  {photo.file.name}
                                </span>
                                <span
                                  className={`mt-0.5 block text-[11px] font-bold ${
                                    hasCoordinates(photo)
                                      ? "text-[var(--periplus-olive)]"
                                      : "text-[var(--periplus-coral)]"
                                  }`}
                                >
                                  {hasCoordinates(photo)
                                    ? "已标记"
                            ...
                            <button
                              ...
                              title="移除"
                              className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-[var(--periplus-teak)] transition hover:bg-[rgb(44_36_22_/_7%)] hover:text-[var(--periplus-coral)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--periplus-russet)]"
                            >
                ...
                <div className="flex h-full min-h-[240px] flex-col items-center justify-center rounded-[12px] border border-dashed border-[rgb(44_36_22_/_16%)] bg-[var(--periplus-soft-white)] p-6 text-center">
                  <ImagePlus
                    aria-hidden="true"
                    className="h-8 w-8 text-[var(--periplus-teak)]"
                  />
                  <p className="mt-3 text-sm font-black text-[var(--periplus-ink)]">
                    选择照片后编辑
                  </p>
                </div>
              )}
            ...
            {validationError && (
              <p className="border-t border-[rgb(44_36_22_/_10%)] px-4 py-3 text-xs leading-5 font-bold text-[var(--periplus-coral)]">
                {validationError}
              </p>
            )}
          </aside>
