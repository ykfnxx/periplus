...
export default function PhotoLightbox() {
  ...
  return (
    <div
      ...
      className="pointer-events-auto fixed inset-0 z-[100] flex items-center justify-center bg-ink-70 sm:p-4"
    >
      <div
      ...
      >
        ...
        <aside className="flex basis-2/5 flex-col border-t border-ink-10 bg-soft-white p-6 sm:border-t-0 sm:border-l">
          <div className="mb-5 flex items-center gap-3">
            ...
            <div>
              <div className="text-sm font-semibold text-ink">照片分享</div>
              <div className="text-xs text-teak">位置未记录</div>
            </div>
          </div>
