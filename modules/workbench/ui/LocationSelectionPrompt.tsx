...
export default function LocationSelectionPrompt() {
  ...
  return (
    <div className="pointer-events-none absolute inset-x-0 top-5 z-50 flex justify-center px-4">
      <div className="pointer-events-auto flex max-w-[min(520px,calc(100vw-32px))] items-center gap-3 rounded-full border border-[rgb(44_36_22_/_14%)] bg-[var(--periplus-soft-white)] px-3 py-2 text-[var(--periplus-ink)] shadow-[var(--periplus-shadow)]">
        {selectedPhoto ? (
          <img
          ...
          <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[var(--periplus-cream)] text-[var(--periplus-russet)]">
            <MapPin aria-hidden="true" className="h-5 w-5" />
          </span>
        )}
        <div className="min-w-0 flex-1">
          <p className="truncate text-sm leading-5 font-black">在地图上选点</p>
          <p className="truncate text-xs leading-4 font-bold text-[var(--periplus-teak)]">
            点击地图为照片记录坐标
          </p>
        </div>
        <button
          ...
          aria-label="取消选点"
          title="取消选点"
          className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-[var(--periplus-walnut)] transition hover:bg-[rgb(44_36_22_/_7%)] hover:text-[var(--periplus-ink)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--periplus-russet)]"
        >
