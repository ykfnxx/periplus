...
function autoPrompt(messages: AgentConversationMessage[]) {
  ...
  return [
    ...
    "TOOLS: 可选 periplus.place.search；地点确认 periplus.place.resolve；可选图片 periplus.place.enrich；酒店推荐 periplus.hotel.search",
    "SAVE: placeResolutionIdByCardId, hotelSelectionIdByCardId",
    "BRANCH: resolved -> 保存 handle；ambiguous/not_found -> STAGE 10；图片 warning -> 继续；证据齐全 -> STAGE 05",
